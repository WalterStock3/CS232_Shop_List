	 ...
	 *
	 */
	public class ShoppingListProductOLD extends ListItemBase implements Purchasable {
		...
		public ShoppingListProductOLD(String initName) {
			super(initName);
			itemPriority = -1;
			itemPrice = -1.0;
			itemPurchased = false;
		...
		public ShoppingListProductOLD(String initName, int initPriority) {
			super(initName);
